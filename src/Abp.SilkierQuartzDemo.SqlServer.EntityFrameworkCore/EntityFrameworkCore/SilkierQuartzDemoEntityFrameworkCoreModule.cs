...
[DependsOn(
    typeof(SilkierQuartzDemoDomainModule),
...
public class SilkierQuartzDemoSqlServerEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<SilkierQuartzDemoDbContext>(options =>
        {
