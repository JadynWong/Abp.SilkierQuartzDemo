...
public class SilkierQuartzDemoDbMigrationService : ITransientDependency
{
    public ILogger<SilkierQuartzDemoDbMigrationService> Logger { get; set; }

    private readonly IDataSeeder _dataSeeder;
    private readonly IEnumerable<ISilkierQuartzDemoDbSchemaMigrator> _dbSchemaMigrators;
    private readonly ITenantRepository _tenantRepository;
    private readonly ICurrentTenant _currentTenant;

    public SilkierQuartzDemoDbMigrationService(
        IDataSeeder dataSeeder,
        IEnumerable<ISilkierQuartzDemoDbSchemaMigrator> dbSchemaMigrators,
        ...
        ICurrentTenant currentTenant)
    {
        ...
        Logger = NullLogger<SilkierQuartzDemoDbMigrationService>.Instance;
    }
